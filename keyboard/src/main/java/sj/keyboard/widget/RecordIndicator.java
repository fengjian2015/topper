...
public class RecordIndicator {
    ...
    private static int[] amps = {R.drawable.amp1, R.drawable.amp2, R.drawable.amp3, R.drawable.amp4, R.drawable.amp5, R.drawable.amp6, R.drawable.amp7};
    ...
    private void cancelRecord(boolean dismiss) {
        ...
        showView(RecordView.CANCEL_VIEW);
        if (dismiss) {
