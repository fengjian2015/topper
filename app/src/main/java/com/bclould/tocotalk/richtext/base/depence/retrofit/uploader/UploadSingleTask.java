...
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.api.UploadState;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.api.Uploader;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.beans.BaseUploadBean;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.beans.RequestBodyWrapper;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.beans.UploadBeanFactory;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.beans.UploadProgress;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.utils.UploadBeanUtil;
import com.bclould.tocotalk.richtext.base.depence.retrofit.uploader.utils.UploadHelper;
import com.bclould.tocotalk.richtext.base.depence.rxjava.RxSchedulers;
...
public class UploadSingleTask {
    ...
    private UploadSingleTask(RxUploader.TaskController controller) {
        this.mTaskController = controller;
    }
    ...
    public void prepareReceiveEvent(Uploader.OnUploadListener listener){
        mOnUploadListener = listener;
        this.filterNum = 0;
    }

    public void prepareReceiveEvent(Uploader.OnUploadListener listener, int filterNum){
        mOnUploadListener = listener;
    ...
    public void receiveEvent(){
        if(mOnUploadListener != null)
            receiveEvent(mOnUploadListener,filterNum);
    }
