...
public class Validator {
     ...
     * 正则表达式：验证用户名
     */
    public static final String REGEX_USERNAME = "^[a-zA-Z0-9\u4E00-\u9FA5]+$";
    ...
    public static class NameLengthFilter implements InputFilter{
        ...
        public NameLengthFilter(int mMax) {
            mMax = mMax;
        }
    ...
    public static boolean isTooShort(String s,int length){
        return length > getLength(s);
    }
