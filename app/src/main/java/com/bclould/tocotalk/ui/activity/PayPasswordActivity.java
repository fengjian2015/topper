...
import com.bclould.tocotalk.Presenter.PayPasswordPresenter;
...
public class PayPasswordActivity extends BaseActivity {
    ...
    private void submit() {
        ...
        if (!googleCode.isEmpty()) {
            ...
            payPasswordPresenter.submit(googleCode, password, password2);
        } else {
    ...
    private void eyeShowHidden(int index, boolean isEye) {
        ...
        if (index == 0) {
            ...
            if (isEye) {
                ...
                mEtPayPassword2.setSelection(mEtPayPassword.length());
    ...
    private boolean checkEdit() {
        if (mEtPayPassword.getText().toString().trim().equals("")) {
            Toast.makeText(this, getString(R.string.toast_pay_password), Toast.LENGTH_SHORT).show();
