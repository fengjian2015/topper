...
public class DialogManager {
    ...
    public void recording() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.yuyin_voice_1));
    ...
    public void wantToCancel() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg2.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.yuyin_cancel));
    ...
    public void tooShort() {
        if (mDialog != null && mDialog.isShowing()) {
            ...
            imgBg.setVisibility(View.GONE);
            tipsTxt.setVisibility(View.GONE);
            imgBg2.setBackgroundDrawable(mContext.getResources().getDrawable(R.mipmap.yuyin_gantanhao));
