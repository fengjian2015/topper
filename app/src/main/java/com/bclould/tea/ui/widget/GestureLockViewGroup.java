...
public class GestureLockViewGroup extends RelativeLayout {
                                ...
                                int defStyle)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (attr)
            {
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_color_no_finger_inner_circle:
                    mNoFingerInnerCircleColor = a.getColor(attr,
                            mNoFingerInnerCircleColor);
                    break;
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_color_no_finger_outer_circle:
                    mNoFingerOuterCircleColor = a.getColor(attr,
                            mNoFingerOuterCircleColor);
                    break;
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_color_finger_on:
                    mFingerOnColor = a.getColor(attr, mFingerOnColor);
                    break;
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_color_finger_up:
                    mFingerUpColor = a.getColor(attr, mFingerUpColor);
                    break;
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_count:
                    mCount = a.getInt(attr, 3);
                    break;
                case R.styleable.GestureLockViewGroup_GestureLockViewGroup_tryTimes:
...
//         mPaint.setColor(Color.parseColor("#aaffffff"));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (mGestureLockViews == null)
        {
            ...
            UtilTool.Log(TAG, "mWidth = " + mWidth + " ,  mGestureViewWidth = "
