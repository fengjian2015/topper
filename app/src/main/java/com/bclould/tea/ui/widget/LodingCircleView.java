...
public class LodingCircleView extends View {
    ...
    private void init() {
        ...
        paintBgCircle.setColor(Color.parseColor("#80ffffff"));


        paintCircle = new Paint();
        paintCircle.setAntiAlias(true);
        paintCircle.setStyle(Paint.Style.FILL);
        paintCircle.setColor(Color.parseColor("#80000000"));


        paintProgressCircle = new Paint();
        paintProgressCircle.setAntiAlias(true);
        paintProgressCircle.setStyle(Paint.Style.FILL);
        paintProgressCircle.setColor(Color.parseColor("#80ffffff"));
