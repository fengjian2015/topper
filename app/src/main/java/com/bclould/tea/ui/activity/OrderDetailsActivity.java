...
public class OrderDetailsActivity extends BaseActivity {
    ...
    private void initDialog(final int type) {
        ...
        if (type == 0) {
            countCoin.setText(getString(R.string.cancel_order_hint));
        } else if (type == 1) {
            countCoin.setText(getString(R.string.fk_hint));
        } else if (type == 2) {
            countCoin.setText(getString(R.string.fb_hint));
        }
//        coin.setTextSize(getResources().getDimension(R.dimen.x24));
