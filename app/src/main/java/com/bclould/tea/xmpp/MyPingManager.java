...
public class MyPingManager extends Manager {
     ...
     * @throws SmackException.NoResponseException if there was no response from the jid.
     * @throws SmackException.NotConnectedException
     */
    public boolean ping(Jid jid, long pingTimeout) throws SmackException.NotConnectedException, SmackException.NoResponseException, XmppStringprepException, InterruptedException {
        ...
        Ping ping = new Ping(JidCreate.entityBareFrom(jid));
        try {
    ...
    /**
     * Same as calling  with the defaultpacket reply
     * timeout.
     *
     * @param jid The id of the entity the ping is being sent to
     * @return true if a reply was received from the entity, false otherwise.
     ...
     * @throws SmackException.NoResponseException if there was no response from the jid.
     */
    public boolean ping(Jid jid) throws SmackException.NotConnectedException, SmackException.NoResponseException, XmppStringprepException, InterruptedException {
     ...
     * @throws XMPPException.XMPPErrorException An XMPP related error occurred during the request
     * @throws SmackException.NoResponseException if there was no response from the jid.
     * @throws SmackException.NotConnectedException
     */
    public boolean isPingSupported(String jid) throws SmackException.NoResponseException, XMPPException.XMPPErrorException, SmackException.NotConnectedException, XmppStringprepException, InterruptedException {
        return ServiceDiscoveryManager.getInstanceFor(connection()).supportsFeature(JidCreate.entityBareFrom(jid), Ping.NAMESPACE);
    }
     ...
     * <p>
     * Unlike the  case, this method will return true even if
     * {@link #isPingSupported(String)} is false.
     *
     * @return true if a reply was received from the server, false otherwise.
     * @throws SmackException.NotConnectedException
     */
    public boolean pingMyServer() throws SmackException.NotConnectedException, XmppStringprepException, InterruptedException {
     ...
     * @throws SmackException.NotConnectedException
     */
    public boolean pingMyServer(boolean notifyListeners) throws SmackException.NotConnectedException, XmppStringprepException, InterruptedException {
     ...
     * @throws SmackException.NotConnectedException
     */
    public boolean pingMyServer(boolean notifyListeners, long pingTimeout) throws SmackException.NotConnectedException, XmppStringprepException, InterruptedException {
        boolean res;
        try {
     ...
     */
    public void pingServerIfNecessary() throws XmppStringprepException, InterruptedException {
