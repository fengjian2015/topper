...
public abstract class BaseFragment extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        UtilTool.Log(TAG, "setUserVisibleHint() -> isVisibleToUser: " + isVisibleToUser);
        if (rootView == null) {
            return;
        }
        hasCreateView = true;
    ...
    protected void onFragmentVisibleChange(boolean isVisible) {
        UtilTool.Log(TAG, "onFragmentVisibleChange -> isVisible: " + isVisible);
    }
}
