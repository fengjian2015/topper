...
import com.dashiji.biyun.ui.activity.CurrencyInOutActivity;
...
public class CloudCoinRVAdapter extends RecyclerView.Adapter {
    ...
    private final List<MyAssetsInfo.LtcBean> mMyAssetsBeanList;
    private final FragmentActivity mActivity;

    public CloudCoinRVAdapter(FragmentActivity activity, List<MyAssetsInfo.LtcBean> MyAssetsBeanList) {
        mActivity = activity;
    ...
    class ViewHolder1 extends RecyclerView.ViewHolder {
        private MyAssetsInfo.LtcBean mLtcBean;
        ...
        public void setData(MyAssetsInfo.LtcBean ltcBean) {
            mLtcBean = ltcBean;
