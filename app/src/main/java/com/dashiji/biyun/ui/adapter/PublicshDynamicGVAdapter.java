 ...
 * data：16/7/27
 */
public class PublicshDynamicGVAdapter extends
        RecyclerView.Adapter<PublicshDynamicGVAdapter.ViewHolder> {
    ...
    public  PublicshDynamicGVAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_publish_dynamic,
                viewGroup, false);
